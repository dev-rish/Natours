...
// 'options' is just another http method sent by browser just before any non-simple request (i.e all except GET and POST or the ones that use non-standard header or cookie)
app.options('*', cors());
