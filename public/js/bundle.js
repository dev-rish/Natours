...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); // Inside body, at the beginning

  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // Hide alert after 5000ms
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged out successfully!'); // This will prevent reload from browser catch
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(oldPassword, newPassword, newPasswordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2VicnVtb3RpcyIsImEiOiJjazh6cXNyNmwxazRxM3BzN2Uwc3d6c29wIn0.c-hMoTe2cFvtbHlKQ-XdKQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kebrumotis/ck8zqy4tn01wf1im4tpgswlx8',
    center: [-118.6919229, 34.0201613],
    scrollZoom: false,
    showZoom: true // zoom: 10,
    // interactive: false
...
var stripe = Stripe('pk_test_VornsSEdSHlG4OeU9Ujd7SRx00NMqtZs6D');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    if (password === passwordConfirm) {
      ...
      (0, _alerts.showAlert)('error', 'Passwords do not match! Please try again', 5000);
    }
  });
}
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var saveButton, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              saveButton = document.querySelector('.btn--save-password');
